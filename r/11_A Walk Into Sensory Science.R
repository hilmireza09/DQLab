#------------------------ chapter 2 ------------------------
#Ilmu Sensoris 101
#Pengenalan mengenai ilmu sensoris
...
#------------------------ chapter 2 ------------------------
# Cokelat Setelah mempelajari sedikit teori mengenai ilmu sensoris, 
#sekarang mari kita belajar sedikit lebih dalam mengenai analisis 
#data riset sensoris. Anda akan diajak melakukan analisis data untuk 
#mempelajari karakteristik sensoris produk cokelat komersial. 
